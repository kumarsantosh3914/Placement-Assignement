...
function editTodo() {
  ...
  const todoText = todoName.textContent; // Get the current todo text

  // Create a modal for editing the todo
  ...
  function updateTodo(event) {
    ...
    const editedText = editInput.value.trim(); // Get the edited text
